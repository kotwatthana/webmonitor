...
String 
firmwareInfo      = "VER4.0  ",
firmwareDate      = "03/07/24",
firmwareContactR1 = "www.youtube.com/",  
firmwareContactR2 = " AODDY-DIY-2024 ";
...
voltageBatteryMin       = 11.0000,     //   USER PARAMETER - Minimum Battery Charging Voltage (Output V)
currentCharging         = 30.0000,     //   USER PARAMETER - Maximum Charging Current (A - Output)
electricalPrice         = 4.18000;      //   USER PARAMETER - Input electrical price per kWh (Dollar/kWh,Euro/kWh,Peso/kWh)
...
float
inVoltageDivRatio       = 79.2350,    //  300K+3.9K 160V
outVoltageDivRatio      = 40.8500,    //  200K+5.1K 80V
vOutSystemMax           = 80.0000,    //  โวลท์ออก 80V
cOutSystemMax           = 50.0000,    //  แอมป์ออก 50A 
ntcResistance           = 9750.00,   //  CALIB PARAMETER - NTC temp sensor's resistance. Change to 10000.00 if you are using a 10k NTC
...
currentMidPoint         = 2.5000,     //  CALIB PARAMETER - Current Sensor Midpoint (V)
currentSens             = 0.0000,     //  CALIB PARAMETER - Current Sensor Sensitivity (V/A)
currentSensV            = 0.0500,     //  CALIB PARAMETER - Current Sensor Sensitivity (mV/A)
